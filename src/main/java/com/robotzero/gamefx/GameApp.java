...
//    private Sphere sphere = new Sphere(200);
...
//        Rotate cameraRotateX = new Rotate(-20, Rotate.X_AXIS);
//        Rotate cameraRotateY = new Rotate(0, Rotate.Y_AXIS);
//        Rotate cameraRotateZ = new Rotate(0, Rotate.Z_AXIS);
//        Translate cameraTranslate = new Translate(0, 0, -20);
//        camera.getTransforms().addAll(
//                cameraRotateX,
//                cameraRotateY,
//                cameraRotateZ,
//                cameraTranslate);
//        group.getChildren().addAll(camera, box);
//        pane = new Pane(camera, box);
//    }
//
//    @Override
